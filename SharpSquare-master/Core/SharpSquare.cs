...
namespace FourSquare.SharpSquare.Core
{
    public class SharpSquare
    {
        ...
        private String GetMultiple(string endpoint, Dictionary<string, string> parameters) 
        {
            string serializedParameters = "";
            if (parameters != null)
            {
            ...
            return Request(string.Format("{0}{1}?{2}{3}&v={4}", apiUrl, endpoint, oauthToken, serializedParameters, apiVersion), HttpMethod.GET);
        }
        ...
        */
        ...
        public String GetRecentCheckinMio(Dictionary<string, string> parameters)
        {
            return GetMultiple("/checkins/recent", parameters);
        }
